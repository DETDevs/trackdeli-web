...
import { useResetAdminUserPassword } from '../../hooks/useAdminUsers';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err?.response?.status === 403) {
        setErrorMessage('No tienes permisos para modificar la contraseña de este usuario');
      } else {
        ...
        {successPassword ? (
          <div className="space-y-4">
            <div className="bg-green-50 border border-green-200 text-green-800 text-xs rounded-lg p-3">
              ¡Contraseña cambiada exitosamente! Compártela con el cajero para su próximo inicio de sesión.
            </div>
